  ...
  return (
    ...
    >
      ...
      <div className="relative h-44 overflow-hidden bg-surface">
        ...
        >
          <Heart
            className={`w-4 h-4 transition-colors ${liked ? "fill-red-400 text-red-400" : "text-white/60"}`}
          />
        </motion.button>
          ...
          <div className="absolute top-2.5 left-2.5 flex flex-wrap gap-1">
            {product.badges.slice(0, 2).map((badge) => {
              ...
              return (
                <span
                  key={badge}
                  className={`px-2 py-0.5 rounded-full text-[10px] font-semibold border ${b.cls}`}
                >
