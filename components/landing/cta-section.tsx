...
const stats = [
  { valueEn: '5+',   valueAr: '+5',   labelEn: 'Years of flavor', labelAr: 'سنوات من الطعم' },
  { valueEn: '20k+', valueAr: '+20k', labelEn: 'Orders delivered',labelAr: 'طلب تم توصيله' },
  { valueEn: '4.9★', valueAr: '★4.9', labelEn: 'Average rating',  labelAr: 'متوسط التقييم' },
  { valueEn: '<30s', valueAr: '<30ث', labelEn: 'Order via WhatsApp',labelAr: 'اطلب عبر واتساب' },
]
    ...
    <section className="py-24 bg-background" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
        ...
        <motion.div
          ...
          style={{
            backgroundImage: 'radial-gradient(ellipse at 70% 50%, oklch(0.75 0.18 52 / 0.12) 0%, transparent 60%)',
          }}
        >
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="space-y-4 text-center lg:text-start">
              <h2 className="text-4xl sm:text-5xl font-extrabold text-foreground text-balance">
                {isRtl
                  ? <>جاهز للطلب؟<br /><span className="text-primary">نحن جاهزون لك</span></>
                  : <>Ready to order?<br /><span className="text-primary">We&apos;re ready for you</span></>
                }
              </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <h3 className="font-bold text-foreground">{isRtl ? titleAr : titleEn}</h3>
