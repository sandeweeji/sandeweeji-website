...
export default function ReviewsSection() {
  ...
  return (
    <section className="py-24 bg-[oklch(0.08_0.008_45)]" dir={isRtl ? 'rtl' : 'ltr'}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">{t('reviewSubtitle', locale)}</p>
        </motion.div>
...
function ReviewCard({
  ...
  const avatarColors = ['bg-amber-500', 'bg-orange-500', 'bg-red-400', 'bg-yellow-500', 'bg-emerald-500']
